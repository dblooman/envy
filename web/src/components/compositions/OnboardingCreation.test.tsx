...
it("requires a digest and includes the reviewed revision in an explicitly submitted preview", async () => {
...
it("offers preparation when an approval is missing and blocks override creation", async () => {
  ...
  expect(prepare).toHaveBeenCalledWith({ project: "shop", baseline: "review" });
  expect(context.createComposition).not.toHaveBeenCalled();
});
