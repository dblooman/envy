    ...
    <div className="grid max-w-5xl gap-5 lg:grid-cols-2">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Effective, sanitized control-plane configuration.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-3 text-sm">
          {installation ? (
            <dl className="grid grid-cols-2 gap-3">
              ...
              <div>
                <dt className="text-muted-foreground">Composition limit</dt>
                <dd>{installation.max_compositions}</dd>
              </div>
              <div>
                <dt className="text-muted-foreground">Default / maximum TTL</dt>
                <dd>
          ...
          {(
            ...
            return (
              <button
                ...
                className={`rounded-lg border p-3 text-left ${theme === option.id ? "border-foreground bg-muted" : "border-border"}`}
              >
