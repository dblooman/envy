...
export const INITIAL_MOCK_COMPOSITIONS: Composition[] = [
  {
    ...
    conditions: [
      ...
      { type: 'RoutesConfigured', status: true, message: 'VirtualService and Envoy baggage routing active' },
      { type: 'RouteVerified', status: true, message: 'Synthetic probe verified through ingress' },
    ],
    latest_operation: {
      id: 'op-01999999-0001',
      kind: 'update',
  ...
  },
  {
    ...
    conditions: [
      { type: 'WorkloadsReady', status: false, message: 'Pulling image envy/service-b:v3' },
      { type: 'RoutesConfigured', status: true, message: 'Istio routing rules staged' },
      { type: 'RouteVerified', status: false, message: 'Awaiting workload readiness probe' },
    ],
    latest_operation: {
      id: 'op-01999999-0002',
      kind: 'create',
  ...
  },
  {
    ...
    conditions: [
      ...
      { type: 'RoutesConfigured', status: true, message: 'VirtualService updated' },
      { type: 'RouteVerified', status: true, message: 'Routing verification 200 OK' },
    ],
    latest_operation: {
      id: 'op-01999999-0003',
      kind: 'update',
